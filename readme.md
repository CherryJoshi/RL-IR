...
|REPNP: Plug-and-Play with Deep Reinforcement Learning Prior for Robust Image Restoration<br><sub>Chong Wang, ongkai Zhang, Saiprasad Ravishankar<sub>        | ICIP 2022|[paper](https://arxiv.org/abs/2207.12056)|[code] |利用轻量级的基于DRL的去噪器进行鲁棒的图像恢复任务，将PnP框架与基于DRL的去噪器相结合，通过随机状态奖励来训练网络，可以获得更一般的策略|2022|
